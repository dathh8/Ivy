...
<section class="cartegory">
    <div class="container">
        <div class="cartegory-top row">
                    <?php
                    if($get_name_category = $cartegory->get_name_category($cartegory_id)){
                       while($result_name = $get_name_category->fetch_assoc()) {
                    ?>
            <p><a href="index.php">Trang chủ</a></p> <span>&rarr;</span><p><?php echo $result_name['danhmuc_ten'] ?></p><span>&rarr;</span><p><?php echo $result_name['loaisanpham_ten'] ?></p>
            <?php }} ?>
        </div>
    </div>
    <div class="container">
            ...
            <div class="cartegory-right row">
                <div class="cartegory-right-top-item">
                    ...
                    if($get_name_category = $cartegory->get_name_category($cartegory_id)){
                       while($result_name = $get_name_category->fetch_assoc()) {
                    ?>
                    <p><?php echo $result_name['loaisanpham_ten'] ?></p>
                    <?php }} ?>
                </div>
                <div class="cartegory-right-top-item">
                ...
                <div class="cartegory-right-content row">
                    <?php
                    if($get_product_by_category = $cartegory->get_product_by_category($cartegory_id)){
                       while($result = $get_product_by_category->fetch_assoc()) {
